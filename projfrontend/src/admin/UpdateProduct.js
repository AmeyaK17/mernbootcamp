...
const UpdateProduct = ({match}) => {  //destructing of props
    ...
    const [values, setValues] = useState({
        ...
        createdProduct: "",
        getRedirect: false,
        formData: "", //We are converting our form to an object to be able to submit all of the info to the backend
    });
    ...
    const handleChange = name => event => {
        const value = name === "photo" ? event.target.files[0] : event.target.value //will have filename or value
